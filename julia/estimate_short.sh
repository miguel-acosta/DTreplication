...
#SBATCH --job-name=lDTMHshort    # The job name.
#SBATCH --nodes 1
#SBATCH --ntasks 1
...
#SBATCH -e /rigel/home/jma2241/coursework/uribe/error_HPC_short.txt
#SBATCH -o /rigel/home/jma2241/coursework/uribe/output_HPC_short.txt
